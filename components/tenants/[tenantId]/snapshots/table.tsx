...
import { ListSnapshots } from "@/taiwan-geodoc-hub/modules/registration-managing/application/queries/list-snapshots"
...
export default function SnapshotsTable() {
    const t = useTranslations(Pages.Snapshots)
                                    ...
                                    <TableBody>
                                        {snapshots.map((snapshot) => (
                                            <TableRow key={snapshot.id}>
                                                ...
                                                <TableCell className="font-medium">
                                                    <Link
                                                        href={Pages.Registrations.replace(
                                                            "[tenantId]",
                                                            tenantId,
                                                        ).replace(
                                                            "[snapshotId]",
