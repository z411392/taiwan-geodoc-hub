...
// import { plans } from "@/taiwan-geodoc-hub/modules/auditing/constants/plans"
// import { useContainer } from "~/composables/contexts/with-resolve-tenant"
// import { RetrieveContactInfo } from "@/taiwan-geodoc-hub/modules/customer-supporting/application/retrieve-contact-info"

export default function ({ currentPoints }: { currentPoints: number }) {
    return <></>
    ...
    // const retrieveContactInfo = useMemo(
    //     () => container.resolve(RetrieveContactInfo),
    //     [container],
    // )
    // useEffect(() => {
    //     const run = async () => {
    //         const contactInfo = await retrieveContactInfo()
    ...
    //             description: __("notifications.copied.description", {
    //                 content,
    //             }),
    //             duration: 1500,
    //         })
    ...
    //                             {t(
    //                                 "sections.current-points-balance.description",
    //                                 {
    ...
    //                                     className="h-7 px-2"
    //                                     onClick={() =>
    //                                         copyToClipboard(contactInfo.mobile)
    //                                     }
    //                                 >
    ...
    //                                     className="h-7 px-2"
    //                                     onClick={() =>
    //                                         copyToClipboard(contactInfo.lineId)
    //                                     }
    //                                 >
    //                                     <Copy className="h-3.5 w-3.5" />
    //                                 </Button>
    ...
    //                                 <br />
    //                                 {t.rich(
    //                                     "sections.point-consumption.description",
    //                                     {
    //                                         br: () => <br />,
    //                                     },
    //                                 )}
