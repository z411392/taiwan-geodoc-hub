...
import { onListingDashboardInsights } from "@/lib/modules/reporting/presentation/ui/on-listing-dashboard-insights"
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {t("sections.transcripts.description", {
