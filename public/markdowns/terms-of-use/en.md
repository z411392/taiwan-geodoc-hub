...
LandDoc Hub is a SaaS platform designed for Taiwanese land data users, providing land transcript analysis and announcement value query functions, supporting multi-tenant, multi-role, and point system management.

## 2. Use Rules

By using this service, you agree to comply with these terms of use.

## 3. Membership and Point System

This service adopts a membership and point system model:

- Using this service requires point consumption.
- The first time using transcript analysis or announcement value query will deduct points, and re-attempting will not deduct points.
- Points are purchased offline, please contact customer service for details.
