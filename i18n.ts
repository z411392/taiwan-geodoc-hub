...
export default getRequestConfig(async ({ locale }) => {
    ...
    const withResolveTenant = await new Promise<Record<string, any>>(
        (resolve) => {
            Promise.all([
                import(
                ...
                import(
                    `~/public/locales/components/(with-resolve-tenant)/upload-snapshot-button/dialog-trigger/${locale}.json`
                ),
                import(
                    `~/public/locales/components/(with-resolve-tenant)/upload-snapshot-button/dialog-header/${locale}.json`
                ),
                import(
                    `~/public/locales/components/(with-resolve-tenant)/upload-snapshot-button/drag-drop/${locale}.json`
                ),
                import(
                    `~/public/locales/components/(with-resolve-tenant)/upload-snapshot-button/select-file-button/${locale}.json`
                ),
                import(
                    `~/public/locales/components/(with-resolve-tenant)/upload-snapshot-button/dialog-footer/${locale}.json`
                ),
                import(
                ...
                ([
                    ...
                    { default: UploadSnapshotButtonDialogTrigger },
                    { default: UploadSnapshotButtonDialogHeader },
                    { default: UploadSnapshotButtonDragDrop },
                    { default: UploadSnapshotButtonSelectFileButton },
                    { default: UploadSnapshotButtonDialogFooter },
                    ...
                    { default: CrawlValuesButtonDialogTrigger },
                    { default: CrawlValuesButtonDialogHeader },
                    { default: CrawlValuesButtonDragDrop },
                    { default: CrawlValuesButtonSelectFileButton },
                    { default: CrawlValuesButtonDialogFooter },
                ]) => {
                    resolve({
                        ...
                        "(with-resolve-tenant)/header/inbox/view-all-button":
                            ViewAllButton,
                        "(with-resolve-tenant)/upload-snapshot-button/dialog-trigger":
                            UploadSnapshotButtonDialogTrigger,
                        "(with-resolve-tenant)/upload-snapshot-button/dialog-header":
                            UploadSnapshotButtonDialogHeader,
                        "(with-resolve-tenant)/upload-snapshot-button/drag-drop":
                            UploadSnapshotButtonDragDrop,
                        "(with-resolve-tenant)/upload-snapshot-button/select-file-button":
                            UploadSnapshotButtonSelectFileButton,
                        "(with-resolve-tenant)/upload-snapshot-button/dialog-footer":
                            UploadSnapshotButtonDialogFooter,
                        "(with-resolve-tenant)/tutorials/header":
                            TutorialsHeader,
