import { type SnapshotDao } from "@/taiwan-geodoc-hub/modules/registration-managing/domain/ports/snapshot-dao"
...
@injectable()
export class SnapshotAdapter implements SnapshotDao {
    constructor(
        @inject(idTokenToken) protected readonly idToken: string,
    ...
    async byPage(_keyword: string, _page: number) {
